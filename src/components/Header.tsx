      ...
      <div className="max-w-7xl mx-auto page-container p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          >
            ...
            />
            <span className="text-left text-brand-dark font-bold text-xl">
              BrightPlanner
            </span>
          </a>
        </div>
        ...
        <nav className="hidden sm:flex items-center space-x-2">
          <Link
            to="/"
            className="px-3 py-1.5 rounded-md text-neutral-dark hover:bg-neutral-lightest transition"
          >
            Hjem
          </Link>
      ...
      >
        <div className="page-container max-w-7xl mx-auto p-3 flex flex-col gap-2">
          <Link
            to="/"
            onClick={close}
            className="px-3 py-2 rounded-md text-neutral-dark hover:bg-neutral-lightest transition"
          >
            Hjem
          </Link>
          <Link
